    ...
    {productList?
     <div className="row gx-4 gx-lg-5 align-items-center">
                    <div className="col-md-6">
                        ...
                        <img className="card-img-top mb-5 mb-md-0" src={productList.image_url
}  />
                    ...
                    <div className="col-md-6">
                        ...
                        <div className="fs-5 mb-5">
                            ...
                            <span className='text-danger'>{Number(productList.asset_contract?.seller_fee_basis_points).toFixed(2)}  USD </span>:[]}
                        </div>
